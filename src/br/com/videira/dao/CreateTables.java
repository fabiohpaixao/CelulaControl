...
public class CreateTables {
    ...
    public void createTableMembro() {
    	...
    	try {
    		...
    		sql = "CREATE TABLE tmenbro (ID INT GENERATED BY DEFAULT AS IDENTITY (START WITH 2, INCREMENT BY 1), Nome VARCHAR(250), TelResidencial VARCHAR(20), TelComercial VARCHAR(20), TelCelular1 VARCHAR(20), TelCelular2 VARCHAR(20), Email VARCHAR(150), DataNascimento DATE, FuncaoID INT, Encontro INT, Batismo INT, Cursao INT, CTL INT, Consolidado INT, Consolidador INT, PRIMARY KEY (ID))";	
